...
INSERT INTO options (option_id, option_name, destination_situation, option_text) VALUES
    ...
    (37, 'IS HE TELLING THE TRUTH? (WISDOM CHECK)', NULL, 'Special option to see if Father Daragor is lying'),
...
INSERT INTO situations (situation_id, situation_text, image_link, option_1, option_2, option_3, option_4) VALUES
    ...
    (28, ' Sagh relpy''s with a grim expression. Sagh: You''d better go to the barn and look', 'https://cdn.discordapp.com/attachments/1194709723820343336/1203839628654682142/E1C2_Inn.jpg?ex=65d28e05&is=65c01905&hm=99c125c2ed752359dfdbcdf8baff58a46bf2a2349a5748c064c7f55eae420569&', 42, NULL, NULL, NULL);
